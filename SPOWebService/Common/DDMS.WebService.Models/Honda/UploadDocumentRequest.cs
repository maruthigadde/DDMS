...
namespace DDMS.WebService.Models.Honda
{
    public class UploadDocumentRequest
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9_\~\!\@\#\$\%\^\&\(\)\-\`\+\=\{\[\}\]\;\'\,]{1,400}\.(doc|ppt|xls|pdf|zip|jpg|tif|gif|DOC|PPT|XLS|PDF|ZIP|JPG|TIF|GIF)$", ErrorMessage = @"Document name should be of max 400 characters and special-characters like '/*\<|>?""' are not allowed")]
